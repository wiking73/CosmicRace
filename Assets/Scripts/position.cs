...
public class Position : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // najpierw obliczamy post�p (closest waypoint) wszystkich wci�� �cigaj�cych si�
        ...
        // rozdzielamy list� na finished i racing
        ...
        // 1) Sortujemy finishedCars wed�ug kolejno�ci w finishOrder
        finishedCars = finishedCars
            .OrderBy(c => finishedNames.IndexOf(c.name))
            .ToList();

        // 2) Sortujemy racingCars po waypoint + odleg�o��
        racingCars.Sort((a, b) =>
        {
